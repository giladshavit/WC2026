...
const ALL_STAGES = [
  ...
  { name: 'GROUP_CYCLE_2', label: 'Group Cycle 2', value: 2, fine: 1 },
  { name: 'GROUP_CYCLE_3', label: 'Group Cycle 3', value: 3, fine: 2 },
  { name: 'PRE_ROUND32', label: 'Pre Round of 32', value: 4, fine: 2 },
  { name: 'ROUND32', label: 'Round of 32', value: 5, fine: 2 },
  { name: 'PRE_ROUND16', label: 'Pre Round of 16', value: 6, fine: 3 },
  { name: 'ROUND16', label: 'Round of 16', value: 7, fine: 3 },
  { name: 'PRE_QUARTER', label: 'Pre Quarter Final', value: 8, fine: 3 },
  { name: 'QUARTER', label: 'Quarter Final', value: 9, fine: 3 },
  { name: 'PRE_SEMI', label: 'Pre Semi Final', value: 10, fine: 4 },
  { name: 'SEMI', label: 'Semi Final', value: 11, fine: 4 },
  { name: 'THIRD_PLACE', label: '3rd Place Match', value: 12, fine: 4 },
  { name: 'PRE_FINAL', label: 'Pre Final', value: 13, fine: 4 },
  { name: 'FINAL', label: 'Final', value: 14, fine: 4 },
  { name: 'TOURNAMENT_OVER', label: 'Tournament Over', value: 15, fine: 4 },
];
