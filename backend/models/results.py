...
class BonusResults(Base):
    ...
    g3_interim = Column(String, nullable=True)
    g4_interim = Column(String, nullable=True)
    g5_interim = Column(String, nullable=True)
    g6_interim = Column(String, nullable=True)
    k1_interim = Column(String, nullable=True)
    k2_interim = Column(String, nullable=True)
    k3_interim = Column(String, nullable=True)
    t1_interim = Column(String, nullable=True)
    t2_interim = Column(String, nullable=True)
    t3_interim = Column(String, nullable=True)
