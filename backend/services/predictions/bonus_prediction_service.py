    ...
    def get_options(db: Session) -> Dict[str, List[Dict[str, str]]]:
        ...
        return {
            ...
            "t3": [
                ...
                {"value": "yamal", "label": "Lamine Yamal", "flag": "es"},
                {"value": "messi", "label": "Lionel Messi", "flag": "ar"},
                {"value": "ronaldo", "label": "Cristiano Ronaldo", "flag": "pt"},
                {"value": "lukaku", "label": "Romelu Lukaku", "flag": "be"},
                {"value": "vinicius", "label": "Vinícius Jr.", "flag": "br"},
                {"value": "lautaro", "label": "Lautaro Martínez", "flag": "ar"},
                {"value": "bellingham", "label": "Jude Bellingham", "flag": "gb-eng"},
                {"value": "alvarez", "label": "Julián Álvarez", "flag": "ar"},
                {"value": "gakpo", "label": "Cody Gakpo", "flag": "nl"},
                {"value": "saka", "label": "Bukayo Saka", "flag": "gb-eng"},
                {"value": "nunez", "label": "Darwin Núñez", "flag": "uy"},
                {"value": "wirtz", "label": "Florian Wirtz", "flag": "de"},
                {"value": "dembele", "label": "Ousmane Dembélé", "flag": "fr"},
                {"value": "bruno", "label": "Bruno Fernandes", "flag": "pt"},
                {"value": "memphis", "label": "Memphis Depay", "flag": "nl"},
                {"value": "salah", "label": "Mohamed Salah", "flag": "eg"},
                {"value": "mane", "label": "Sadio Mané", "flag": "sn"},
